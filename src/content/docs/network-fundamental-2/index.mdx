---
title: "Pengantar: Network Fundamental 2"
course: "network-fundamental-2"
language: id
order: 0
durationMinutes: 5
description: "Pengantar dan silabus lengkap kursus Network Fundamental 2."
---
<Callout type="info" title="Selamat Datang di Kursus Ini!">
  Selamat datang di kursus **Network Fundamental 2**. Pelajari setiap bab materi secara bertahap, kerjakan kuis evaluasi, dan unduh berkas praktik Cisco Packet Tracer untuk mendapatkan poin XP serta menaikkan jenjang pangkat maritim Anda.
</Callout>
